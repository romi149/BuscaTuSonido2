<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Grafico-FOpinionPreg1.aspx.cs" Inherits="GUI.Grafico_FOpinionPreg1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: 'POST',
                url: "Grafico-FOpinionPreg1.aspx/GraficaBarras",
                dataType: "json",
                ...
                success: function (result) {
                    ...
                    var options = {
                        title: '',
                        hAxis: {
                            title: '¿Qué tan fácil te pareció el proceso de compra?'
                        },
                        vAxis: {
                            title: 'Total'
                        },
