<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Grafico-FOpinionPreg2.aspx.cs" Inherits="GUI.Grafico_FOpinionPreg2" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: 'POST',
                url: "Grafico-FOpinionPreg2.aspx/GraficaBarras",
                dataType: "json",
                ...
                success: function (result) {
                    ...
                    var options = {
                        title: '',
                        hAxis: {
                            title: '¿Te resultó fácil encontrar el producto que buscabas?'
                        },
                        vAxis: {
                            title: 'Total'
                        },
