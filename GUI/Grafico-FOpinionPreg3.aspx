<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Grafico-FOpinionPreg3.aspx.cs" Inherits="GUI.Grafico_FOpinionPreg3" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            $.ajax({
                type: 'POST',
                url: "Grafico-FOpinionPreg3.aspx/GraficaBarras",
                dataType: "json",
                ...
                success: function (result) {
                    ...
                    var options = {
                        title: '',
                        hAxis: {
                            title: '¿Qué tan satisfecho estás con la disponibilidad de los productos?'
                        },
                        vAxis: {
                            title: 'Total'
                        },
